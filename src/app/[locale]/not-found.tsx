  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col items-center justify-center px-5 pb-20 pt-10 text-center sm:px-8">
      <div className="rounded-3xl border border-black/10 bg-white p-10 shadow-sm dark:border-white/10 dark:bg-neutral-950">
        ...
        <Link
          href="/"
          className="mt-6 inline-flex rounded-full border border-neutral-900 bg-neutral-900 px-5 py-2.5 text-sm font-semibold !text-white shadow-sm shadow-black/10 transition hover:bg-neutral-800 dark:border-white/20 dark:bg-white dark:!text-neutral-950 dark:hover:bg-neutral-100"
        >
          {t("backHome")}
        </Link>
      </div>
